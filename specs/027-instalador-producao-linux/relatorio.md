...
**Data**: 2026-09-19 | **Spec**: [spec.md](./spec.md) | **Plan**: [plan.md](./plan.md) | **Tasks**: [tasks.md](./tasks.md)
...
| FR-010 `.env` 0600, percent-encoding, nunca sobrescrito (SR-002, R6) | `build_database_url` (`quote_plus`), `ensure_env_file` (`umask 077`, backup `.env.bak-<ts>`, merge só de chaves ausentes com consentimento) |
...
| FR-016 log com níveis + arquivo 0600 (R1/R2) | `setup_logging` (`/var/log/sispatrimonio-install.log` via `tee`), `info/ok/warn/err` |
