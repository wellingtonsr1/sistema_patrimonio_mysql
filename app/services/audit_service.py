...
# Destino externo de backups (feature 045 — aditivo; contract §3)
ACTION_BACKUP_DESTINO_EXTERNO_CONFIGURADO = "BACKUP_DESTINO_EXTERNO_CONFIGURADO"
ACTION_BACKUP_DESTINO_EXTERNO_TESTADO = "BACKUP_DESTINO_EXTERNO_TESTADO"
ACTION_BACKUP_EXTERNO_SUCESSO = "BACKUP_EXTERNO_SUCESSO"
ACTION_BACKUP_EXTERNO_FALHA = "BACKUP_EXTERNO_FALHA"
...
# Feature 031 — Integração 1Doc (padrão ACTION_*; research D11)
ACTION_INTEGRACAO_1DOC_SOLICITADA = "INTEGRACAO_1DOC_SOLICITADA"
ACTION_INTEGRACAO_1DOC_ENVIADA = "INTEGRACAO_1DOC_ENVIADA"
...
# Coleta offline de inventário (feature 033 — aditivo; research D6)
ACTION_INVENTARIO_OFFLINE_PREPARADO = "INVENTARIO_OFFLINE_PREPARADO"
ACTION_INVENTARIO_OFFLINE_SYNC = "INVENTARIO_OFFLINE_SYNC"
ACTION_INVENTARIO_OFFLINE_CONFLITO = "INVENTARIO_OFFLINE_CONFLITO"
ACTION_INVENTARIO_OFFLINE_REJEITADO = "INVENTARIO_OFFLINE_REJEITADO"
ACTION_INVENTARIO_OFFLINE_RECONCILED = "INVENTARIO_OFFLINE_RECONCILED"
...
ACTION_LABELS: Dict[str, str] = {
    ...
    # Destino externo de backups (045)
    ACTION_BACKUP_DESTINO_EXTERNO_CONFIGURADO: "Destino Externo de Backup Configurado",
    ACTION_BACKUP_DESTINO_EXTERNO_TESTADO: "Destino Externo de Backup Testado",
    ACTION_BACKUP_EXTERNO_SUCESSO: "Backup Externo Realizado",
    ACTION_BACKUP_EXTERNO_FALHA: "Backup Externo Falhou",
    # Notificação por e-mail (030)
    ACTION_NOTIFICACAO_ENVIADA: "Notificação Enviada",
    ACTION_NOTIFICACAO_FALHOU: "Notificação Falhou",
    ACTION_INTEGRACAO_1DOC_SOLICITADA: "Integração 1Doc Solicitada",
    ...
    ACTION_INVENTARIO_OFFLINE_PREPARADO: "Inventário Preparado para Coleta Offline",
    ACTION_INVENTARIO_OFFLINE_SYNC: "Sincronização Offline de Inventário",
    ACTION_INVENTARIO_OFFLINE_CONFLITO: "Conflito Offline de Inventário",
    ACTION_INVENTARIO_OFFLINE_REJEITADO: "Coleta Offline Rejeitada",
    ACTION_INVENTARIO_OFFLINE_RECONCILED: "Conflito Offline Reconciliado",
